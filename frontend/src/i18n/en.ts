...
/**
 * English messages. Scoped to what the Login phase needs (common/auth/errors) —
 * more namespaces (dashboard, projects, editor, ...) get added as those
 * screens are built in later phases, ported from frontend-legacy/src/lib/i18n/en.ts.
 */
