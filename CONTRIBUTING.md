...
- Search [existing issues](https://github.com/sxnnyside-scholarships/bubble-catcher/issues) before opening a new one.
...
Open a [GitHub Issue](https://github.com/sxnnyside-scholarships/bubble-catcher/issues/new/choose) using the bug report template.
...
Open a [GitHub Issue](https://github.com/sxnnyside-scholarships/bubble-catcher/issues/new/choose) using the feature request template, or submit a PR directly if the change is small and self-contained.
...
- [ ] The project builds without errors (`just check` passes)
