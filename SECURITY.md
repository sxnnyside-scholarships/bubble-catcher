...
If you find a security vulnerability in **Bubble Catcher**, report it privately before disclosing it publicly.

**Preferred channel:**
Email — `legal.sxnnyside@sxnnysideproject.com`

**Alternative:**
[GitHub Private Security Advisory](https://github.com/sxnnyside-scholarships/bubble-catcher/security/advisories/new)
...
This policy covers the **Bubble Catcher** repository only.
